  ...
  return (
    <div className={className}>
      ...
      <Transition show={isNavVisible} as={Fragment}>
        <nav className="fixed w-full bg-darkgrey text-lightgrey transition-transform duration-200 transform translate-y-0 lg:translate-y-full" style={{ justifyContent: 'center', alignItems: 'center', margin: 0, padding: 0 }}>
